...
class AdminController extends Controller
{
    ...
    public function adminIndex(Request $request, $tab = 'notice')
    {
        ...
        $data['reports'] = Ticket::where('type', '2')->orWhere('type', '3')->orWhere('type', '4')->orWhere('type',
            '5')->orderby('id', 'dsc')->paginate(40);
    ...
    public function testEmail(Request $request)
    {
        ...
        $mailSettings = [];
        $mailSettings["Body"] = view('auth.checkLetter')->with([
            'host' => $request->server("HTTP_HOST"),
            'token' => "sometesttokenhhhh",
        ])->render();
