  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs card-header-tabs" role="tab-list">
        <li class="nav-item"><a class="nav-link active" href="#announcement" role="tab" data-toggle="tab"
                                aria-controls="announcement">公告管理</a></li>
        <li class="nav-item"><a class="nav-link" href="#classify" role="tab" data-toggle="tab" aria-controls="classify">分类管理</a>
        </li>
        <li class="nav-item"><a class="nav-link" href="#report" role="tab" data-toggle="tab" aria-controls="report">查看举报记录</a>
        </li>
        <li class="nav-item"><a class="nav-link" href="#userlist" role="tab" data-toggle="tab" aria-controls="userlist">查看所有用户</a>
        </li>
        <li class="nav-item"><a class="nav-link" href="#translist" role="tab" data-toggle="tab"
                                aria-controls="translist">交易列表</a></li>
      </ul>
    </div>
