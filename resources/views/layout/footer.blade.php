...
<div class="footer container">
  @if(env('APP_DEBUG'))
    <div class="row">
      <div class="mx-auto">当前处于调试模式</div>
    </div> @endif
  @if(env('SHOW_VER'))
    <div class="row">
      <div class="mx-auto">程序版本：{{ config('app.version') }}&nbsp;&nbsp; 文件版本：<a
  ...
  <div class="d-none d-md-flex row">
    ...
    <ul class="col-auto ml-auto">
      ...
      <li><a href="https://about.neupioneer.com">关于我们</a></li>
    </ul>
  </div>
  {{-- <div class="row"><div class="mx-auto">© </div></div> --}}
  <div class="d-md-none row">
    <ul class="col-auto mr-auto">
      <li>© {{date("Y")}} <a href="https://about.neupioneer.com">东北大学先锋网</a></li>
