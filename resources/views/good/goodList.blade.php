...
@section('content')
  <div class="row">
    ...
    <div class="col-auto nav-item dropdown">
      <a class="nav-link dropdown-toggle" href="#" role="button" id="sort" data-toggle="dropdown" aria-haspopup="true"
         aria-expanded="false">商品排序</a>
    ...
    <div class="d-none" id="ds">
      <a>价格筛选</a>
      <input id="priceSet1" class="form-control"
             value="@if(isset($_GET['start_price'])){{ $_GET['start_price'] }}@endif" /> - <input id="priceSet2"
                                                                                                  class="form-control"
                                                                                                  value="@if(isset($_GET['end_price'])){{ $_GET['end_price'] }}@endif" />
      <button class="btn btn-primary" onclick="setc('a')">确定</button>
    </div>
    <div class="col-auto nav-item dropdown" style="list-style-type:none;">
      <a class="nav-link dropdown-toggle" href="#" role="button" id="price" data-toggle="dropdown" aria-haspopup="true"
         aria-expanded="false">价格区间</a>
        ...
        <div class="good">
          <a href="/good/{{ $good->id }}">
            <div class="card" style="box-shadow:1px 1px 2px #aaaaaa;border-style:none">
              <div class="card-img-top">
                ...
                <div class="details" style="position:absolute;z-index:200;width:100%;display:none;">
                  <div class="det-d d-none d-md-block"
                       style="position:absolute;z-index:200;top:-37px;left:5px;color:lightgrey;font-size:12px;">
                    售价：￥{{ $good->price }}
                    <br />
                    @if($good->count==0)
                      无库存QAQ
                ...
                <div class="d-block d-sm-none" style="position:absolute;z-index:200;width:100%;height:25%;">
                  <div class="det-d"
                       style="position:absolute;z-index:200;top:-18px;color:black;font-size:12px;filter:opacity(50%);background-color: black;right:0;border-radius:5px 0px 0 0px;">
                    ￥{{ $good->price }}&nbsp;
                  </div>
                  <div class="det-d"
                ...
                <div class="d-none d-sm-none" style="position:absolute;z-index:200;width:100%;height:25%;">
                  <div class="det-d"
                       style="position:absolute;z-index:200;top:-18px;color:black;font-size:12px;filter:opacity(50%);background-color: black;left:0;border-radius:0px 5px 0 0px;">
                    @if($good->count==0)
                      <span>无库存QAQ</span>
                    @else
              ...
              <div class="card-body"
                   style="word-break:break-all;font-size:12px;padding:3px 7px;color:black;filter:opacity(90%);height:40px;">
