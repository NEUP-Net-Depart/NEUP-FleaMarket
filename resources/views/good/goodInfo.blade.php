...
@section('content')
    ...
    <div class="row">
        ...
        <div>
            <div class="reveal" id="exampleModal1" data-reveal data-close-on-click="true" data-animation-in="fade-in" data-animation-out="fade-out" style="top:+10px">
               <br/> <h5>修改商品</h5><br/>
                @if (count($errors) > 0)
                    <label>
    ...
    <div class="row">
        ...
        <script src="/js/good/goodedit.js"></script>
    <script>
