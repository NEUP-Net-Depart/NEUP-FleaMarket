@if ($paginator->hasPages())
    ...
    <ul class="pagination" id="_list">
        ...
        @else
            <li class="page-item mbl"><a class="page-link pre" href="{{ $paginator->previousPageUrl() }}" rel="prev">&laquo;</a></li>
        @endif
        ...
        @if ($paginator->hasMorePages())
            <li class="page-item mbl"><a class="page-link nt" href="{{ $paginator->nextPageUrl() }}" rel="next">&raquo;</a></li>
        @else
