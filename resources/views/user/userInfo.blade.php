<div id="userinfo-container">
  ...
  <div class="row">
    <div class="mx-auto">
      <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#add-form" aria-expanded="false"
              aria-controls="add-form"><span class="fa fa-plus"> 添加联系方式</span></button>
    </div>
  </div>
  <div class="row">
    <div class="mx-auto">
